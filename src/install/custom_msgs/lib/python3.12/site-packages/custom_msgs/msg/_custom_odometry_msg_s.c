...
bool custom_msgs__msg__custom_odometry_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._custom_odometry_msg.CustomOdometryMsg", full_classname_dest, 54) == 0);
  }
  custom_msgs__msg__CustomOdometryMsg * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of CustomOdometryMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._custom_odometry_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CustomOdometryMsg");
